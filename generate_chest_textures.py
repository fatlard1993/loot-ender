#!/usr/bin/env python3
"""Generate this mod's chest clasps: vanilla's chest with a recoloured clasp.
...
JAR = _jars[-1]
OUT_DIR = os.path.join(HERE, "src/main/resources/assets/loot-ender/textures/entity/chest")
...
VARIANTS = {
    ...
    "sealed": {
        (118, 118, 118): (204, 142, 39),
        (134, 134, 134): (211, 150, 50),
        (145, 145, 145): (249, 189, 35),
        (165, 165, 165): (245, 204, 39),
        (194, 194, 194): (255, 216, 62),
        (205, 205, 205): (255, 236, 79),
    },
}
